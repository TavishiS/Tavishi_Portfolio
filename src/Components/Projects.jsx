  ...
  return (
    ...
    <div id='Projects' className='p-10 md:p-24 text-white'>
        ...
        <div className='py-12 px-8 flex flex-wrap gap-5'>
            <ProjectCard title={title1} main={main1} bannerImg={emo2mov} rep_link={rep_link1} git_link={git_link1}/>
            <ProjectCard title={title2} main={main2} bannerImg={todo} rep_link={rep_link2} git_link={git_link2}/>
            <ProjectCard title={title3} main={main3} bannerImg={face} rep_link={rep_link3} git_link={git_link3}/>
            <ProjectCard title={title4} main={main4} bannerImg={sms} rep_link={rep_link4} git_link={git_link4}/>
            <ProjectCard title={title5} main={main5} bannerImg={quiz} rep_link={rep_link5} git_link={git_link5}/>
        </div>
